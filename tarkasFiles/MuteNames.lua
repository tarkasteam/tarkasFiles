...
if DevRio:get(tarkas.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(tarkas.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(tarkas.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
tarkasName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if tarkasName then 
tarkasNames = DevRio:smembers(tarkas.."Rio:Mute:Names"..msg.chat_id_) or ""
if tarkasNames and tarkasNames[1] then 
for i=1,#tarkasNames do 
if tarkasName:match("(.*)("..tarkasNames[i]..")(.*)") then 
...
DevRio:set(tarkas.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(tarkas.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
